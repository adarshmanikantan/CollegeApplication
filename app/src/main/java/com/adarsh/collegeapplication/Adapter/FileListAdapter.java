...
public class FileListAdapter extends RecyclerView.Adapter<FileListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String s=context.getString(R.string.uri, mediaFile.getPath());
        SharedPreferences sharedPreferences=context.getSharedPreferences("syllabus",Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=sharedPreferences.edit();
        editor.putString("key1",s);
        editor.apply();
        holder.filePath.setText(context.getString(R.string.uri, mediaFile.getPath()));
