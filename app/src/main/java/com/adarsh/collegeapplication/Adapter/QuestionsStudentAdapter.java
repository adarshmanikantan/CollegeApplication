...
public class QuestionsStudentAdapter extends RecyclerView.Adapter<QuestionsStudentAdapter.MyViewHolder> {
    Context context;
    ViewQuestionModel viewQuestionModel;
//    private ProgressDialog pDialog;
    public QuestionsStudentAdapter(Context context, ViewQuestionModel viewQuestionModel)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.questions_student_row,parent,false);
        QuestionsStudentAdapter.MyViewHolder holder=new QuestionsStudentAdapter.MyViewHolder(view);
        return holder;
    }
        ...
        holder.download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             //   new DownloadFile().execute(url, "five-point-someone-chetan-bhagat_ebook.pdf");
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://docs.google.com/viewer?"+url));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            sub=itemView.findViewById(R.id.questions_student_subject);
            subcode=itemView.findViewById(R.id.questions_student_subcode);
            download=itemView.findViewById(R.id.questions_student_downloadbtn);
        }
    }
