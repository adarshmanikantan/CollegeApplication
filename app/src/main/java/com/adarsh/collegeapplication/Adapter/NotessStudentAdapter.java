...
public class NotessStudentAdapter extends RecyclerView.Adapter<NotessStudentAdapter.MyViewHolder> {
    Context context;
    ViewNotesModel viewNotesModel;
//    private ProgressDialog pDialog;
    public NotessStudentAdapter(Context context, ViewNotesModel viewNotesModel)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.notes_student_row,parent,false);
        NotessStudentAdapter.MyViewHolder holder=new NotessStudentAdapter.MyViewHolder(view);
        return holder;
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            sub=itemView.findViewById(R.id.subjnotes_student_txtview);
            subcode=itemView.findViewById(R.id.note_student_subcode);
            download=itemView.findViewById(R.id.note_student_download);
        }
    }
