...
public class EventsStudentAdapter extends RecyclerView.Adapter<EventsStudentAdapter.MyViewHolder> {
    Context context;
    ViewEventModel viewEventModel;
    public EventsStudentAdapter(Context context,ViewEventModel viewEventModel)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.event_student_row,parent,false);
        EventsStudentAdapter.MyViewHolder holder=new EventsStudentAdapter.MyViewHolder(view);
        return holder;
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
       TextView title,date,desc;
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            title=itemView.findViewById(R.id.studentevent_txtview);
            date=itemView.findViewById(R.id.studenteventdatetxt);
            desc=itemView.findViewById(R.id.studentevent_desc_txt);
        }
